...
describe('fetchProjectFilterSaga', () => {
	...
	it('calls resolveApiUrl', () => {
		...
		expect(saga.next().value).toEqual(call(resolveApiUrl, 'REACT_APP_PROJECT_FILTER_ROUTE', { projectId: projectId }))
	})
...
describe('fetchProjectFilterOperatorsSaga', () => {
	...
	it('calls resolveApiUrl', () => {
		...
		expect(saga.next().value).toEqual(
			call(resolveApiUrl, 'REACT_APP_PROJECT_FILTER_OPERATORS_ROUTE', { projectId: projectId })
		)
	})
