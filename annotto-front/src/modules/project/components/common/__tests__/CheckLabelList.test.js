...
describe('CheckLabelList', () => {
  ...
  describe('matches snapshot', () => {
    const data = [
      { title: 'with no data', props: { tasks: [], annotations: [{ value: 'RA' }], onChange: null } },
      { title: 'with tasks', props: { tasks, annotations: [{ value: 'RA' }], onChange: null } },
      {
        title: 'with tasks && annotations',
        props: { tasks: [], annotations: [{ value: 'RA' }], onChange: null },
      },
    ]
